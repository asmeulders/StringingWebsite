...
class Orders(db.Model):
    ...
    @classmethod
    def create_order(cls, customer_id: int, racket_id: int, order_date: date, mains_tension: int, crosses_tension: int, mains_string_id: int, crosses_string_id: int, paid: bool, completed: bool = False) -> None:
        """
